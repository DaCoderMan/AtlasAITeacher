...
const EXPECTED = [
  ...
  'atlas_learning_create_item', 'atlas_learning_due_reviews', 'atlas_learning_submit_review', 'atlas_learning_metrics',
...
test('read tools are annotated read-only and write/automation tools are not', () => {
  const read = new Set([
    'atlas_search', 'atlas_context', 'atlas_status', 'atlas_projects', 'atlas_tasks',
    'atlas_learning_due_reviews', 'atlas_learning_metrics', 'atlas_automation_status'
  ]);
